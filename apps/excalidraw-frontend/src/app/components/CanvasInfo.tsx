...
export default function CanvasInfo({
  ...
  return (
    <>
      ...
      {/* Sidebar Panel */}
      <aside
        className={`pointer-events-auto fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-neutral-800 border-l border-neutral-800 transform transition-transform duration-300 ease-out flex flex-col z-30 ${
      ...
      >
        ...
        {/* Header */}
        <div className="relative z-10 flex items-center justify-between px-5 py-4 border-b border-neutral-800/80">
        ...
        <div className="relative z-10 px-5 py-5 border-b border-neutral-800/80">
          <p className="text-[11px] font-medium text-neutral-500 uppercase tracking-wider mb-3">
            Your Profile
          </p>
          <div className="flex items-center gap-4 p-4 py-3 rounded-md bg-neutral-900/50 border border-neutral-800 hover:shadow-[inset_0px_-15px_30px_rgba(255,255,255,0.02)] transition-all duration-200">
            {/* Avatar */}
            <div className="relative flex-shrink-0">
              <div
                className="w-12 h-12 rounded-full bg-[linear-gradient(135deg,var(--c1),var(--c2))] shadow-lg"
                style={
                  {
                    "--c1": color1,
                    "--c2": color2,
            ...
            <div className="flex-1 min-w-0">
              {currentUser?.username ? (
                <>
                  <p className="text-base font-semibold text-neutral-100 truncate leading-tight">
                    {currentUser.username}
                  </p>
