...
export default function DashboardPage() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-8 py-12  relative">
      <div className="absolute h-full border-x border-x-neutral-800 right-0 w-30 bg-[image:repeating-linear-gradient(315deg,_var(--color-neutral-800)_0,_var(--color-neutral-800)_1px,transparent_0,_transparent_50%)] bg-[size:10px_10px]"></div>
      <div className="absolute h-full border-x border-x-neutral-800 left-0 w-30 bg-[image:repeating-linear-gradient(315deg,_var(--color-neutral-800)_0,_var(--color-neutral-800)_1px,transparent_0,_transparent_50%)] bg-[size:10px_10px]"></div>
